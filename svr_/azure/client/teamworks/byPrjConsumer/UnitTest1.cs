...
namespace nilnul.fs._git_._TEST_.srv_.azure.client.teamworks
...
namespace nilnul.fs._git_._TEST_.srv_.azure.client.teamworks
{
	...
	public class UnitTest1
	{
		...
		public void TestMethod1()
		{
			...
			var org = Environment.GetEnvironmentVariable("nilnul.fs.git.svr_.azure._client.Org"
...
Uri uriBase = new Uri(client.spear());
			VssBasicCredential credentials = new VssBasicCredential("", client.token);

			using (ProjectHttpClient projectHttpClient = new ProjectHttpClient(uriBase, credentials))
			{
