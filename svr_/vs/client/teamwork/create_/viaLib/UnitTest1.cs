...
namespace nilnul.fs._git_._TEST_.srv_.vs.client.teamwork.create_.viaLib
	...
	//Microsoft.Azure.DevOps.ClientSamples.ProjectsAndTeams
{
		...
		//: ClientSample
	{
		...
		public ProjectsSample()
		{
			...
			var clientAzure = nilnul.fs.git.svr_.vs.Client.CreateFroVault();


			var personalAccessToken = clientAzure.credential.password;//.token;// nilnul.win.app_._CredManX.Get(keyName);



			String c_collectionUri = clientAzure.origin();//. ; $"https://dev.azure.com/{org}";
